...
+ [How it works](how-it-works.md)
   + [Languages and locales supported by Amazon Lex](how-languages.md)
...
+ [Deploying bots](deploying.md)
   ...
   + [Deploying an Amazon Lex bot on a messaging platform](deploying-messaging-platform.md)
      + [Integrating an Amazon Lex bot with Facebook Messenger](deploy-facebook-messenger.md)
      ...
      + [Integrating an Amazon Lex bot with Slack](deploy-slack.md)
      ...
      + [Integrating an Amazon Lex bot with Twilio SMS](deploy-twilio-sms.md)
...
+ [Streaming to an Amazon Lex bot](streaming.md)
...
+ [Monitoring Amazon Lex](monitoring-overview.md)
